...
public class EntryServerResponse implements Serializable {
    ...
    private EntryServerResponse(OperationType opType, String receivedCommand, boolean isSuccessful, Object data) {
        this.opType = opType;
     ...
     */
    public static EntryServerResponse ok(OperationType opType, String receivedCommand, Object data) {
     ...
     * @return EntryServerResponse
     */
    public static EntryServerResponse error(OperationType opType, String receivedCommand, Exception e) {
